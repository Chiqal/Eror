...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              #if msg.from_ in admin:
                cl.sendText(msg.to,"Hadir coy")
                ki.sendText(msg.to,"Aya naon")
                ki2.sendText(msg.to,"Cabok kuaeng")
                ki.sendText(msg.to,"Semua Udah Hadir Boss\nSiap Protect Group\nAman Gak Aman Yang Penting josss")
