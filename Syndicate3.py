...
#----------------------------------------------
              ...
              #if msg.from_ in admin:
                md = "Protection S̸͟͞Y̸͟͞N̸͟͞D̸͟͞I̸͟͞C̸͟͞A̸͟͞T̸͟͞E̸͟͞ P̸͟͞R̸͟͞O̸͟͞T̸͟͞E̸͟͞C̸͟͞T̸͟͞\n_________________\n"
        ...
        #-----------------------------------------
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    ...
                    gs = ki4.getGroup(msg.to)
                    gs = ki5.getGroup(msg.to)
                    cl.sendText(msg.to,"Hello cuy")
                    cl.sendText(msg.to,"Kita Mau sedikit Bersih² Group Sampah Nih")
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              #if msg.from_ in admin:
                #cl.sendText(msg.to,"")
                ki.sendText(msg.to,"ՏվղժíϲɑԵҽᴼᴺ")
                ki2.sendText(msg.to,"ՏվղժíϲɑԵҽᴼᴺ")
                ki3.sendText(msg.to,"ՏվղժíϲɑԵҽᴼᴺ")
                ki4.sendText(msg.to,"ՏվղժíϲɑԵҽᴼᴺ")
                ki5.sendText(msg.to,"ՏվղժíϲɑԵҽᴼᴺ")
                ki.sendText(msg.to,"rєαdч σn\nѕємυα υ∂αн нα∂ιя вσѕѕ")
